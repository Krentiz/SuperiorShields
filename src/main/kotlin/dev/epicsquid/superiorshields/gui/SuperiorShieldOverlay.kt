...
class SuperiorShieldOverlay : IGuiOverlay {
    ...
    private fun drawQuad(
        ...
        val f = 0.00390625f
        val f1 = 0.00390625f
        buffer.vertex((x1 + 0.0f).toDouble(), (y1 + 0.0f).toDouble(), 0.0)
                .uv(minU * f, (minV + maxV) * f1)
                .endVertex()
        buffer.vertex((x2 + 0.0f).toDouble(), (y2 + 0.0f).toDouble(), 0.0)
                .uv((minU + maxU) * f, (minV + maxV) * f1)
                .endVertex()
        buffer.vertex((x3 + 0.0f).toDouble(), (y3 + 0.0f).toDouble(), 0.0)
                .uv((minU + maxU) * f, minV * f1)
                .endVertex()
        buffer.vertex((x4 + 0.0f).toDouble(), (y4 + 0.0f).toDouble(), 0.0)
                .uv(minU * f, minV * f1)
                .endVertex()
    }
    ...
    override fun render(
        ...
        RenderSystem.setShaderTexture(
                0,
                ResourceLocation(SuperiorShields.MODID, "textures/gui/shield.png")
        )
